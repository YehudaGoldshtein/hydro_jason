    ...
    painPoints: [
      {
        id: 1,
        // טקסט נקודת כאב 1
        text: 'נמאס לך "להנדס" כריות שנופלות ברגע שאת זזה ',
        // מילה מודגשת
        highlight: 'מילימטר',
      },
      {
      ...
      {
        id: 3,
        text: 'במקום לישון אחרי האוכל, אנחנו מתמודדים עם שעות של צרחות ',
        highlight: 'גזים',
      },
      {
        id: 4,
  ...
  suitabilityCheck: {
    ...
    notForYou: {
      ...
      items: [
        ...
        'את מאמינה שלהקריב את הגב והבריאות שלך זה חלק מלהיות "אמא טובה"',
      ],
    },
    perfectForYou: {
      // כותרת - מושלם בשבילך
